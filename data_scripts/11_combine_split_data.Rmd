...
s0015 <- read.csv(paste0(path_data, "04_old_split_2000_2015_SD20SD21.csv"), sep = ";")
...
```{r}
write.table(split_0024, "../data/11_old_split_2000_2024_SD20SD21.csv", row.names = F, sep = ";")
```
...
```{r}
write.table(updated_split_0024, "../data/11_updated_split_2000_2024_SD20SD21.csv", row.names = F, sep = ";")
```
