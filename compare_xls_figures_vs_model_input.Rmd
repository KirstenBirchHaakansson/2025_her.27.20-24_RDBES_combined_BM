---
title: "compare_xls_figures_vs_model_input"
...
dat_old <- read.csv(paste0(path_data, "old_canum_with_imputations_2000_2015_IIIa.csv") ,sep = ";")
...
split <- read.csv(paste0(path_data, "old_split_2000_2015_SD20SD21.csv") ,sep = ";")
...
dat_2224 <- read.csv(paste0(path_data, "old_canum_with_imputations_2000_2015_22-24.csv") ,sep = ";")
