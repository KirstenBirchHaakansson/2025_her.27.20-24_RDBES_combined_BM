...
dat <-  read.csv(paste0("../data/updated_canum_without_imputations_2000_2024.csv"), sep = ";")
...
caton_start_sum <- summarise(group_by(caton_start, year),
                             tons_start = sum(catch_t))


caton_end_sum <- summarise(group_by(caton_end, year),
                             tons_end = sum(catch_t))
...
write.table(dat_done, "../data/updated_canum_with_imputations_2000_2024.csv", row.names = F, sep = ";")
...
write.table(dat_split_sum, "../data/updated_canum_with_imputations_for_split_2000_2024.csv", row.names = F, sep = ";")
