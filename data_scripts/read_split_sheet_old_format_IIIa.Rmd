...
# Combine
```{r}
dat <- bind_rows(split_00, split_01, split_02, split_03, split_04, split_05, 
                 split_06, split_07, split_08, split_09, split_10, 
                 split_11, split_12, split_13, split_14, split_15)
rm(split_00, split_01, split_02, split_03, split_04, split_05, 
                 split_06, split_07, split_08, split_09, split_10, 
                 split_11, split_12, split_13, split_14, split_15)
unique(dat$year)
unique(dat$area)
...
# Output
```{r}
write.table(dat, "../data/split_old_format_3a.csv", row.names = F, sep = ";")
```
