...
# dat$weca[dat$ctry == "Sweden" & dat$year == "2014"] <- dat$weca * 1000
# dat$canum[dat$ctry == "Sweden" & dat$year == "2014"] <- dat$canum / 1000
...
write.table(dat, "../data/canum_old_format_22-24.csv", row.names = F, sep = ";")
