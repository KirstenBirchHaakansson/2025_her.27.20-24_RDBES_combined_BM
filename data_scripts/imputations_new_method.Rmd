...
dat <-  read.csv(paste0("../data/C1_her2024_canum_without_imputations_updated_swe.csv"), sep = ";")

dat <- subset(dat, area %in% c("27.3.a.20", "27.3.a.21"))
...
#                              "Faroe Islands ",
#                              "Faroese") &
#                dat$fleet == "C"] <- "trawl >= 32mm" # This I don't know for sure
dat$subFleet[dat$ctry == "Denmark" &
...
write.table(dat_done, "../data/C5_her2024_canum_with_imputations_3a_all.csv", row.names = F, sep = ";")
...
write.table(dat_split_sum, "../data/C5_her2024_canum_with_imputations_for_split_2000_2024.csv", row.names = F, sep = ";")
