...
DK$imputation <- NA
DK$imputation[DK$quarter == 1 & DK$division == "22"] <- "DE, F, Q1, 22"
DK$imputation[DK$quarter == 1 & DK$division == "23"] <- "DK, F, Q1, 24"
DK$imputation[DK$quarter == 2 & DK$division == "22"] <- "DK, F, Q1, 24"
DK$imputation[DK$quarter == 2 & DK$division == "23"] <- "SE, F, Q2, 24"
DK$imputation[DK$quarter == 3 & DK$division == "22"] <- "SE, F, Q3, 24"
DK$imputation[DK$quarter == 3 & DK$division == "23"] <- "SE, F, Q3, 24"
DK$imputation[DK$quarter == 4 & DK$division == "22"] <- "SE, F, Q4, 24"
DK$imputation[DK$quarter == 4 & DK$division == "23"] <- "SE, F, Q4, 24"
...
SE$imputation[SE$quarter == 3 & SE$division == "23"] <- "SE, F, Q1, 24"
SE$imputation[SE$quarter == 4 & SE$division == "23"] <- "SE, F, Q1, 24"
