...
# 2000
Preliminary check against Thomas figures and current time series: N
Imputations checked against report and spread sheet: N
```{r, eval = F}
...
# 2005
Preliminary check against Thomas figures and current time series: Y
Imputations checked against report and spread sheet: Y
```{r}
file <- "HER-IIIa-2005_ok.xls" 
# Fleet E and not fleet D is used - 
#  in the summary and report it looks like E become D, so this will be corrected in the end
